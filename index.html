...
<nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
  <div class="container">
    <a class="navbar-brand" href="index.html"><img src="images/g1logo.png" style="width: 150px;" alt="logo"></a>
...
<footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
          <div class="block">
            <a href="index.html"><img src="images/g1logo.png" style="width: 150px; ;" alt="footer-logo"></a>
            <!-- Social Site Icons -->
  ...
  <div class="text-center bg-dark py-4">
    <small class="text-secondary">Copyright &copy; <script>document.write(new Date().getFullYear())</script>. Designed &amp; Developed by <a href="https://gi1superapp.com/">Gi1</a></small class="text-secondary">
  </div>
</footer>
